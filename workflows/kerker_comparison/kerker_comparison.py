...
from octopus_workflows.oct_workflow_simpler import ground_state_calculation
...
def no_kerker_jobs() -> dict:
    ...
    :return:
    """
    from main_settings import fixed_options, matrix, meta_key, meta_value_ops
    ...
    default_ada_gpu = {'nodes': 1,
                       ...
                       'mail_type': 'none'}
    return ground_state_calculation(matrix, fixed_options, meta_value_ops, default_ada_gpu, oct_root_ada)
